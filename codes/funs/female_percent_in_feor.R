# 97-es feor melletti noi arany
get_female_percent_in_feor97 <- function(df_full, df_sample){
  df_full$feor_2 <- substr(df_full$feor1997_4, 1,2)
  
  df_sample$feor_2 <- substr(df_sample$feor1997_4, 1,2)
...
# 2008-as feor melletti noi arany
get_female_percent_in_feor08 <- function(df_full, df_sample){
  df_full$feor_2 <- substr(df_full$feor2008_4, 1,2)
  
  df_sample$feor_2 <- substr(df_sample$feor2008_4, 1,2)
