...
# random forest
get_A_oax_RF_R1 <- function(df, valt_szama, level_szam, num_tree, feor) {
...
get_A_oax_RF_R2 <- function(df, valt_szama, level_szam, num_tree, feor) {
...
get_B_oax_RF_R1 <- function(df, valt_szama, level_szam, num_tree, feor) {
  randfor_ref <- randomForest(lnker ~ nem+iskveg9 +ujbel + kor +kor2+szolgho+letszam_bv1
...
get_B_oax_RF_R2 <- function(df, valt_szama, level_szam, num_tree, feor) {
  randfor_ref <- randomForest(lnker ~ iskveg9 +ujbel + kor +kor2+szolgho+letszam_bv1
                              + ag1+ ksz+ kag+kol+ ara+ kra+   kshreg + ttip+szesu_v1+ feor_2,
                              na.action=na.omit, mtry=valt_szama,
                              nodesize=level_szam, ntree=num_tree,
...
get_c_oax_RF_R1 <- function(df, valt_szama, level_szam, num_tree, feor) {
  randfor_ref <- randomForest(lnker ~ nem+iskveg9 +ujbel + kor +kor2+szolgho+letszam_bv1
                              + ag1+ ksz+ kag+kol+ ara+ kra+   kshreg + ttip+szesu_v1
                              + nok_aranya,
                              na.action=na.omit, mtry=valt_szama,
...
get_C_oax_RF_R2 <- function(df, valt_szama, level_szam, num_tree, feor) {
  randfor_ref <- randomForest(lnker ~ iskveg9 +ujbel + kor +kor2+szolgho+letszam_bv1
                              + ag1+ ksz+ kag+kol+ ara+ kra+   kshreg + ttip+szesu_v1
                              + nok_aranya,
                              na.action=na.omit, mtry=valt_szama,
